...
> **Note:** For details on the "Mobilité douce" (public transport) features, see [PUBLIC-TRANSPORTATION.md](PUBLIC-TRANSPORTATION.md).
...
```shell
ruff check c2corg_api es_migration
```
