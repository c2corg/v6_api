...
from c2corg_api.scripts.migration_v5.analyze_all_tables import AnalyzeAllTables
from c2corg_api.scripts.migration_v5.area_associations import MigrateAreaAssociations
from c2corg_api.scripts.migration_v5.climbing_site_routes import (
    CreateClimbingSiteRoutes,
)
from c2corg_api.scripts.migration_v5.documents.area import MigrateAreas
from c2corg_api.scripts.migration_v5.documents.articles import MigrateArticles
from c2corg_api.scripts.migration_v5.documents.associations import MigrateAssociations
from c2corg_api.scripts.migration_v5.documents.books import MigrateBooks
from c2corg_api.scripts.migration_v5.documents.images import MigrateImages
from c2corg_api.scripts.migration_v5.documents.maps import MigrateMaps
from c2corg_api.scripts.migration_v5.documents.outings import MigrateOutings
from c2corg_api.scripts.migration_v5.documents.route_title_prefix import (
    SetRouteTitlePrefix,
)
from c2corg_api.scripts.migration_v5.documents.routes import MigrateRoutes
from c2corg_api.scripts.migration_v5.documents.user_profiles import MigrateUserProfiles
from c2corg_api.scripts.migration_v5.documents.versions import MigrateVersions
from c2corg_api.scripts.migration_v5.documents.waypoints.huts import MigrateHuts
from c2corg_api.scripts.migration_v5.documents.waypoints.parking import MigrateParkings
from c2corg_api.scripts.migration_v5.documents.waypoints.products import MigrateProducts
from c2corg_api.scripts.migration_v5.documents.waypoints.sites import MigrateSites
from c2corg_api.scripts.migration_v5.documents.waypoints.summit import MigrateSummits
from c2corg_api.scripts.migration_v5.documents.xreports import MigrateXreports
from c2corg_api.scripts.migration_v5.init_feed import InitFeed
from c2corg_api.scripts.migration_v5.mailinglists import MigrateMailinglists
from c2corg_api.scripts.migration_v5.map_associations import MigrateMapAssociations
from c2corg_api.scripts.migration_v5.sequences import UpdateSequences
from c2corg_api.scripts.migration_v5.set_default_geometries import SetDefaultGeometries
from c2corg_api.scripts.migration_v5.users import MigrateUsers
