...
from c2corg_api.scripts.migration_v5.documents.document import (
    DEFAULT_QUALITY,
    MigrateDocuments,
)
...
class MigrateRoutes(MigrateDocuments):
    ...
    def get_document(self, document_in, version):
        ...
        return dict(
            ...
            configuration=self.convert_types(
                document_in.configuration, MigrateRoutes.route_configuration_types
            ),
            global_rating=self.convert_type(
                document_in.global_rating, MigrateRoutes.global_ratings
            ),
            engagement_rating=self.convert_type(
                document_in.engagement_rating, MigrateRoutes.engagement_ratings
            ),
            equipment_rating=self.convert_type(
                document_in.equipment_rating, MigrateRoutes.equipment_ratings
            ),
            glacier_gear=glacier_gear,
            lift_access=lift_access,
            ski_rating=self.convert_type(
                document_in.toponeige_technical_rating, MigrateRoutes.ski_ratings
            ),
            ...
            labande_ski_rating=self.convert_type(
                document_in.labande_ski_rating, MigrateRoutes.labande_ski_ratings
            ),
            labande_global_rating=self.convert_type(
                document_in.labande_global_rating, MigrateRoutes.global_ratings
            ),
            ice_rating=self.convert_type(
                document_in.ice_rating, MigrateRoutes.ice_ratings
            ),
            mixed_rating=self.convert_type(
                document_in.mixed_rating, MigrateRoutes.mixed_ratings
            ),
            rock_free_rating=self.convert_type(
                document_in.rock_free_rating, MigrateRoutes.climbing_rating
            ),
            rock_required_rating=self.convert_type(
                document_in.rock_required_rating, MigrateRoutes.climbing_rating
            ),
            aid_rating=self.convert_type(
                document_in.aid_rating, MigrateRoutes.aid_ratings
            ),
            hiking_rating=self.convert_type(
                document_in.hiking_rating, MigrateRoutes.hiking_ratings
            ),
            snowshoe_rating=self.convert_type(
                document_in.snowshoeing_rating, MigrateRoutes.snowshoe_ratings
            ),
            risk_rating=self.convert_type(
                document_in.objective_risk_rating, MigrateRoutes.risk_ratings
            ),
    ...
    def get_document_locale(self, document_in, version):
        ...
        return dict(
            ...
            external_resources=self.convert_tags(document_in.external_resources),
    ...
    route_types = {'1': 'return_same_way', '2': 'loop', '3': 'traverse'}
    ...
    exposition_ratings = {'1': 'E1', '2': 'E2', '3': 'E3', '4': 'E4'}
    ...
    snowshoe_ratings = {'1': 'R1', '2': 'R2', '3': 'R3', '4': 'R4', '5': 'R5'}

    risk_ratings = {'2': 'X1', '4': 'X2', '6': 'X3', '8': 'X4', '10': 'X5'}
