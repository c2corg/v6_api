...
class MigrateXreports(MigrateDocuments):
    ...
    def get_document(self, document_in, version):
        return dict(
            ...
            severity=self.convert_type(document_in.severity, MigrateXreports.severity),
            ...
            autonomy=self.convert_type(document_in.autonomy, MigrateXreports.autonomy),
            age=document_in.age,
            gender=self.convert_type(document_in.gender, MigrateXreports.gender),
            previous_injuries=self.convert_type(
                document_in.previous_injuries, MigrateXreports.previous_injuries
            ),
        )
