from c2corg_api.models.common.attributes import CustodianshipTypes
    ...
    def get_custodianship(self, document_in):
        ...
        if document_in.is_staffed:
            if document_in.unstaffed_capacity == 0:
                return CustodianshipTypes.accessible_when_wardened
            else:
                return CustodianshipTypes.always_accessible
        return CustodianshipTypes.no_warden
