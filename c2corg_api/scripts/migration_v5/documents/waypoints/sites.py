...
from c2corg_api.scripts.migration_v5.documents.document import DEFAULT_QUALITY
from c2corg_api.scripts.migration_v5.documents.waypoints.waypoint import (
    MigrateWaypoints,
)
...
class MigrateSites(MigrateWaypoints):
    ...
    def get_document(self, document_in, version):
        ...
        return dict(
            ...
            type=WAYPOINT_TYPE,
            version=version,
            waypoint_type='climbing_indoor' if indoor_types else 'climbing_outdoor',
            ...
            equipment_rating=self.convert_type(
                document_in.equipment_rating, MigrateSites.equipment_ratings, [0]
            ),
            climbing_styles=self.convert_types(
                document_in.climbing_styles, MigrateSites.climbing_styles, [0]
            ),
    ...
    def get_climbing_types(self, document_in):
        ...
        """
        site_types_in = (
            document_in.site_types if document_in.site_types is not None else []
        )
        rock_types_in = (
            document_in.rock_types if document_in.rock_types is not None else []
        )
    ...
    rain_proof_types = {'2': 'exposed', '4': 'partly_protected', '6': 'protected'}
