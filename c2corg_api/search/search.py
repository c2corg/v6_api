...
def search_for_types(search_types, search_term, limit, lang, sort):
    ...
    if document_id is not None:
        ...
        results_for_type = do_multi_search_for_types(
            search_types, search_term, limit, lang, sort)
...
def do_multi_search_for_types(search_types, search_term, limit, lang, sort):
